...
// 表情指令参数
const animVal = {
	angry1: [" is angry.", ["Mouth", "Angry", 75000]],
	angry2: [" is very angry.",
		["Mouth", "Angry", 75000],
		["Eyes", "Angry", 75000],
		["Eyes2", "Angry", 75000],
		["Eyebrows", "Angry", 75000]
	],
	blink: [" blinks her eyes.",
		["Eyes", "Closed", .96],
		["Eyes2", "Closed", .96]
	],
	blush1: [" slightly blushes.", ["Blush", "Low", 2.78]],
	blush2: [" blushes.", ["Blush", "Medium", 2.78]],
	blush3: [" blushes a lot.", ["Blush", "High", 2.78]],
	blush4: [" very strongly blushes.", ["Blush", "VeryHigh", 2.78]],
	blush5: [" extremely blushes.", "Blush", "Extreme", 2.78],
	chuckle: [" chuckles.", "Mouth", "Grin", 1.11],
	closemouth: [" closes her mouth."],
	closeeyes: [" closes her eyes.", ["Eyes", "Closed", 75000],
		["Eyes2", "Closed", 75000]
	],
	confused: [" is confused.", ["Eyebrows", "OneRaised", 75000]],
	cuddle: [" cuddles with her friend.",
		["Eyes", "ShylyHappy", 9.99],
		["Eyes2", "ShylyHappy", 9.99],
		["Eyebrows", "Raised", 9.99],
		["Mouth", "Happy", 9.99]
	],
	cry: [" cries.", ["Fluids", "TearsMedium", 1000, "#000016"]],
	disoriented: [" feels disoriented.",
		["Eyes", "Dizzy", 8.22],
		["Eyes2", "Dizzy", 8.22],
		["Eyebrows", "Raised", 8.22],
		["Blush", "Medium", 8.22]
	],
	droolreset: [" stops to drool."],
	droolsides: [" is drooling.", ["Fluids", "DroolSides", 1000, "#000016"]],
	frown: [" disagrees.", ["Mouth", "Frown", 75000]],
	gaginflate: [" is excited by the inflation of her gag.",
		["Eyes", "Lewd", 4.11],
		["Eyes2", "Lewd", 4.11],
		["Blush", "Medium", 4.11]
	],
	glare: [" looks at everybody with angry eyes.",
		["Eyes", "Angry", 75000],
		["Eyes2", "Angry", 75000],
		["Eyebrows", "Harsh", 75000]
	],
	grin: [" grins.",
		["Eyes", "Horny", 75000],
		["Eyes2", "Horny", 75000],
	...
	happy: [" is happy.", ["Mouth", "Happy", 75000]],
	iced: [" feels the effect of something very cold on her skin.",
		["Eyes", "Surprised", 1.83],
		["Eyes2", "Surprised", 1.83],
		["Mouth", "Angry", 2.11]
	],
	kiss1: [" gives simple kisses to her friend.", ["Mouth", "HalfOpen", 1.44]],
	kiss2: [" kisses her friend on the lips.",
		["Eyes", "Closed", 2.88],
		["Eyes2", "Closed", 2.88],
		["Mouth", "HalfOpen", 2.88],
		["Blush", "Low", 2.88]
	],
	kiss3: [" gives a long kiss to her friend.",
		["Eyes", "Closed", 4.22],
		["Eyes2", "Closed", 4.22],
		["Mouth", "Open", 4.22],
		["Blush", "Medium", 5.00]
	],
	lick: [" licks sensitive body zones of her friend.",
		["Mouth", "Ahegao", 4.11],
		["Blush", "Low", 4.11]
	],
	lipbite: [" bites her lips.", ["Mouth", "LipBite", 75000]],
	narroweyes: [" narrows her eyes.",
		["Eyes", "Horny", 75000],
		["Eyes2", "Horny", 75000]
	],
	neutral: [" goes back to a neutral facial expression."],
	openeyes: [" opens her eyes."],
	openmouth: [" opens her mouth.", ["Mouth", "Moan", 75000]],
	pout: [" pouts.",
		["Mouth", "Pout", 75000],
		["Eyes", "Dazed", 75000],
		["Eyes2", "Dazed", 75000],
	...
	raisebrows: [" raises her brows.", ["Eyebrows", "Raised", 75000]],
	resetbrows: [" feels reassured.", ["Eyebrows", "", 75000]],
	sad: [" is sad.",
		["Mouth", "Frown", 75000],
		["Eyes", "Shy", 75000],
		["Eyes2", "Shy", 75000],
	...
	smile: [" smiles.", ["Mouth", "Grin", 75000]],
	smirk: [" smirks.", ["Mouth", "Smirk", 75000]],
	spanked: [" feels the effect of the spanking on her skin.",
		["Eyes", "Lewd", 2.44],
		["Eyes2", "Lewd", 2.44],
		["Eyebrows", "Soft", 2.44]
	],
	wink: [" winks.", ["Eyes2", "Closed", 1.42]],
	worried: [" is worried.",
		["Eyes", "Surprised", 75000],
		["Eyes2", "Surprised", 75000],
		["Eyebrows", "Soft", 75000]
	]
}
// /bg1指令参数，房间名字
...
function InstructionsAnim2Call(name) {
	if (name == "Anim2") {
		...
		// QAM原版中，该方法重复调用了两次，不清楚为什么这么写，姑且先删减成只调用一次。
		CharacterResetFacialExpression(Player);
		if (animVal.hasOwnProperty(name)) {
			for (let i = 1; i < animVal[name].length; i++) {
				CharacterSetFacialExpression(Player, ...animVal[name][i]);
			}
...
async function NEWmenu() {
	...
	if (CurrentScreen == "ChatRoom") {
		...
		// 		RunExpressionAnimation([null, "Laughing", "Grin", "Laughing", "Happy", "Laughing", "Grin",
		// 			"Laughing", "Happy", null
		// 		]);
		// 		ServerSend("ChatRoomChat", {
		// 			Content: "Beep",
		...
		// 修改在线时间
			...
			if (this.AutoKickOn == false || this.AutoKickOn == undefined) {
				...
				AutoKicker = function(data, days = 1, hours = 12, minutes = 0) {
					...
					if (data.Content == "ServerEnter" && character.Creation > CurrentTime - days - hours -
						minutes) {
			...
			ChatRoomSendLocal(
				"Quick-AccessMenu2: You feel your senses heightened(bondage/evasion). Can see change in information panel."
			);
			...
			if (content.includes("custom") || content.includes("set") || content.includes("select")) {
				ChatRoomSendLocal(
					"Quick-AccessMenu2: You have 5 seconds to click on target, select area. If successful, will be returned. If not, retry."
				);
				setTimeout(function() {
					if (CurrentCharacter.FocusGroup.Name) {
						...
						if (ColorTargetNameCustom !== Player) {
							ServerSend("ChatRoomChat", {
								Content: "Quick-Access Menu2: " + Player.Name +
									" has used colorchanger on you. If this is undesired, blacklist player.",
								Type: "Whisper",
						...
						ColorChangerCustom = function() {
							...
							if (this.ColorTarget1) {
								CharacterAppearanceSetColorForGroup(ColorTargetNameCustom, RandomColor,
									ColorTarget1);
			...
			if (content.includes("change1")) {
				...
				if (target[0] != null) {
					if ((target[0].Name == Player.Name) == false) {
						ServerSend("ChatRoomChat", {
							Content: "Quick-Access Menu2: " + Player.Nickname +
								" will change your normal diapers and allows you to use the /diaper change1 command.",
							Type: "Whisper",
				...
				if (target[0] != null) {
					if ((target[0].Name == Player.Name) == false) {
						ServerSend("ChatRoomChat", {
							Content: "Quick-Access Menu2: " + Player.Nickname +
								" will change your chastity diapers and allows you to use the /diaper change2 command.",
							Type: "Whisper",
							Target: target[0].MemberNumber
						})
					};
				...
				if (target[0] != null) {
					if ((target[0].Name == Player.Name) == false) {
						ServerSend("ChatRoomChat", {
							Content: "Quick-Access Menu2: " + Player.Nickname +
								" will change all your diapers and allows you to use the /diaper change3 command.",
							Type: "Whisper",
							Target: target[0].MemberNumber
						})
					};
				...
				if (InventoryGet(Player, "Panties") != null) {
					if (InventoryGet(Player, "Panties").Asset.Name == "BulkyDiaper" || InventoryGet(Player,
							"Panties").Asset.Name === "PoofyDiaper") {
						var stringSet1 = content;
						var stringSet2 = stringSet1.split(/[ ,]+/);
						var setchange = stringSet2[2];
						if (setchange < diaperDefaultValues.wetLevelInner) {
							...
							ChatRoomSendLocal(
								"Quick-AccessMenu2: Your mess level for normal diapers has been changed.");
						}
					}
				}
			} else if (content.includes("setmess2")) {
				if (InventoryGet(Player, "ItemPelvis") != null) {
					if (InventoryGet(Player, "ItemPelvis").Asset.Name == "BulkyDiaper" || InventoryGet(Player,
							"ItemPelvis").Asset.Name === "PoofyDiaper") {
						var stringSet1 = content;
						var stringSet2 = stringSet1.split(/[ ,]+/);
						var setchange = stringSet2[2];
						if (setchange < diaperDefaultValues.wetLevelOuter) {
							...
							ChatRoomSendLocal(
								"Quick-AccessMenu2: Your mess level for chastity diapers has been changed.");
						}
					}
				}
				...
				if (InventoryGet(Player, "Panties") != null) {
					if (InventoryGet(Player, "Panties").Asset.Name == "BulkyDiaper" || InventoryGet(Player,
						...
						if (setchange > diaperDefaultValues.messLevelInner) {
							...
							ChatRoomSendLocal(
								"Quick-AccessMenu2: Your wet level for normal diapers has been changed.");
						}
					}
				}
				...
				if (InventoryGet(Player, "ItemPelvis") != null) {
					if (InventoryGet(Player, "ItemPelvis").Asset.Name == "BulkyDiaper" || InventoryGet(Player,
						...
						if (setchange > diaperDefaultValues.messLevelOuter) {
							...
							ChatRoomSendLocal(
								"Quick-AccessMenu2: Your wet level for chastity diapers has been changed.");
						}
					}
				}
			...
			if ((PreferenceDifficultyLevel > -1) && (PreferenceDifficultyLevel < 4) && (PreferenceDifficultyLevel !=
			...
			ServerSend("ChatRoomChat", {
				...
				Dictionary: [{
					...
					Text: "" + Player.Nickname +
						" gets grabbed by two maids and locked in the asylum for " + minutes +
						" minutes of training with the Good Girl Training System Level " + level +
						"."
				}]
			});
			...
			AssetFemale3DCG.forEach(group => group.Asset.forEach(item => InventoryAdd(Player, item.Name, group
				.Group)));
			...
			ServerSend("ChatRoomChat", {
				...
				Dictionary: [{
					Tag: "Beep",
					Text: "" + Player.Nickname + " keys are now safe in the vault for " + hours +
						" hours."
				}]
			});
			...
			if (target[0] != null) {
				...
				if ((InventoryGet(target[0], "ItemAddon") != null) && (InventoryGet(target[0], "ItemAddon").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemAddon").Property != null) && (InventoryGet(target[0],
							"ItemAddon").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemAddon")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemAddon").Property.RemoveTimer = InventoryGet(target[0],
								"ItemAddon").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemArms") != null) && (InventoryGet(target[0], "ItemArms").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemArms").Property != null) && (InventoryGet(target[0],
							"ItemArms").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemArms")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemArms").Property.RemoveTimer = InventoryGet(target[0],
								"ItemArms").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemBoots") != null) && (InventoryGet(target[0], "ItemBoots").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemBoots").Property != null) && (InventoryGet(target[0],
							"ItemBoots").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemBoots")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemBoots").Property.RemoveTimer = InventoryGet(target[0],
								"ItemBoots").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemBreast") != null) && (InventoryGet(target[0], "ItemBreast").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemBreast").Property != null) && (InventoryGet(target[0],
							"ItemBreast").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemBreast")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemBreast").Property.RemoveTimer = InventoryGet(target[0],
								"ItemBreast").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemButt") != null) && (InventoryGet(target[0], "ItemButt").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemButt").Property != null) && (InventoryGet(target[0],
							"ItemButt").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemButt")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemButt").Property.RemoveTimer = InventoryGet(target[0],
								"ItemButt").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemDevices") != null) && (InventoryGet(target[0], "ItemDevices")
						.Asset.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemDevices").Property != null) && (InventoryGet(target[0],
							"ItemDevices").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemDevices")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemDevices").Property.RemoveTimer = InventoryGet(target[0],
								"ItemDevices").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemEars") != null) && (InventoryGet(target[0], "ItemEars").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemEars").Property != null) && (InventoryGet(target[0],
							"ItemEars").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemEars")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemEars").Property.RemoveTimer = InventoryGet(target[0],
								"ItemEars").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemFeet") != null) && (InventoryGet(target[0], "ItemFeet").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemFeet").Property != null) && (InventoryGet(target[0],
							"ItemFeet").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemFeet")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemFeet").Property.RemoveTimer = InventoryGet(target[0],
								"ItemFeet").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemHands") != null) && (InventoryGet(target[0], "ItemHands").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemHands").Property != null) && (InventoryGet(target[0],
							"ItemHands").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemHands")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemHands").Property.RemoveTimer = InventoryGet(target[0],
								"ItemHands").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemHead") != null) && (InventoryGet(target[0], "ItemHead").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemHead").Property != null) && (InventoryGet(target[0],
							"ItemHead").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemHead")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemHead").Property.RemoveTimer = InventoryGet(target[0],
								"ItemHead").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemHood") != null) && (InventoryGet(target[0], "ItemHood").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemHood").Property != null) && (InventoryGet(target[0],
							"ItemHood").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemHood")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemHood").Property.RemoveTimer = InventoryGet(target[0],
								"ItemHood").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemLegs") != null) && (InventoryGet(target[0], "ItemLegs").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemLegs").Property != null) && (InventoryGet(target[0],
							"ItemLegs").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemLegs")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemLegs").Property.RemoveTimer = InventoryGet(target[0],
								"ItemLegs").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemMisc") != null) && (InventoryGet(target[0], "ItemMisc").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemMisc").Property != null) && (InventoryGet(target[0],
							"ItemMisc").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemMisc")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemMisc").Property.RemoveTimer = InventoryGet(target[0],
								"ItemMisc").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemMouth") != null) && (InventoryGet(target[0], "ItemMouth").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemMouth").Property != null) && (InventoryGet(target[0],
							"ItemMouth").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemMouth")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemMouth").Property.RemoveTimer = InventoryGet(target[0],
								"ItemMouth").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemMouth2") != null) && (InventoryGet(target[0], "ItemMouth2").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemMouth2").Property != null) && (InventoryGet(target[0],
							"ItemMouth2").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemMouth2")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemMouth2").Property.RemoveTimer = InventoryGet(target[0],
								"ItemMouth2").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemMouth3") != null) && (InventoryGet(target[0], "ItemMouth3").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemMouth3").Property != null) && (InventoryGet(target[0],
							"ItemMouth3").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemMouth3")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemMouth3").Property.RemoveTimer = InventoryGet(target[0],
								"ItemMouth3").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemNeck") != null) && (InventoryGet(target[0], "ItemNeck").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemNeck").Property != null) && (InventoryGet(target[0],
							"ItemNeck").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemNeck")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemNeck").Property.RemoveTimer = InventoryGet(target[0],
								"ItemNeck").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemNeckAccessories") != null) && (InventoryGet(target[0],
						"ItemNeckAccessories").Asset.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemNeckAccessories").Property != null) && (InventoryGet(target[
							0], "ItemNeckAccessories").Property.LockedBy == null)) || (InventoryGet(target[0],
							"ItemNeckAccessories").Property == null)) {
						InventoryLock(target[0], "ItemNeckAccessories", Lock, mn);
						if (removeitem == "r") {
							InventoryGet(target[0], "ItemNeckAccessories").Property.RemoveItem = true;
						}
						if (minutes != null) {
							InventoryGet(target[0], "ItemNeckAccessories").Property.RemoveTimer = InventoryGet(
								target[0], "ItemNeckAccessories").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemNeckRestraints") != null) && (InventoryGet(target[0],
						"ItemNeckRestraints").Asset.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemNeckRestraints").Property != null) && (InventoryGet(target[
							0], "ItemNeckRestraints").Property.LockedBy == null)) || (InventoryGet(target[0],
							"ItemNeckRestraints").Property == null)) {
						InventoryLock(target[0], "ItemNeckRestraints", Lock, mn);
						if (removeitem == "r") {
							InventoryGet(target[0], "ItemNeckRestraints").Property.RemoveItem = true;
						}
						if (minutes != null) {
							InventoryGet(target[0], "ItemNeckRestraints").Property.RemoveTimer = InventoryGet(
								target[0], "ItemNeckRestraints").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemNipples") != null) && (InventoryGet(target[0], "ItemNipples")
						.Asset.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemNipples").Property != null) && (InventoryGet(target[0],
							"ItemNipples").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemNipples")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemNipples").Property.RemoveTimer = InventoryGet(target[0],
								"ItemNipples").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemNipplesPiercings") != null) && (InventoryGet(target[0],
						"ItemNipplesPiercings").Asset.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemNipplesPiercings").Property != null) && (InventoryGet(target[
							0], "ItemNipplesPiercings").Property.LockedBy == null)) || (InventoryGet(target[0],
							"ItemNipplesPiercings").Property == null)) {
						InventoryLock(target[0], "ItemNipplesPiercings", Lock, mn);
						if (removeitem == "r") {
							InventoryGet(target[0], "ItemNipplesPiercings").Property.RemoveItem = true;
						}
						if (minutes != null) {
							InventoryGet(target[0], "ItemNipplesPiercings").Property.RemoveTimer = InventoryGet(
								target[0], "ItemNipplesPiercings").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemNose") != null) && (InventoryGet(target[0], "ItemNose").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemNose").Property != null) && (InventoryGet(target[0],
							"ItemNose").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemNose")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemNose").Property.RemoveTimer = InventoryGet(target[0],
								"ItemNose").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemPelvis") != null) && (InventoryGet(target[0], "ItemPelvis").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemPelvis").Property != null) && (InventoryGet(target[0],
							"ItemPelvis").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemPelvis")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemPelvis").Property.RemoveTimer = InventoryGet(target[0],
								"ItemPelvis").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemTorso") != null) && (InventoryGet(target[0], "ItemTorso").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemTorso").Property != null) && (InventoryGet(target[0],
							"ItemTorso").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemTorso")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemTorso").Property.RemoveTimer = InventoryGet(target[0],
								"ItemTorso").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemTorso2") != null) && (InventoryGet(target[0], "ItemTorso2").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemTorso2").Property != null) && (InventoryGet(target[0],
							"ItemTorso2").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemTorso2")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemTorso2").Property.RemoveTimer = InventoryGet(target[0],
								"ItemTorso2").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemVulva") != null) && (InventoryGet(target[0], "ItemVulva").Asset
						.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemVulva").Property != null) && (InventoryGet(target[0],
							"ItemVulva").Property.LockedBy == null)) || (InventoryGet(target[0], "ItemVulva")
							.Property == null)) {
						...
						if (minutes != null) {
							InventoryGet(target[0], "ItemVulva").Property.RemoveTimer = InventoryGet(target[0],
								"ItemVulva").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
				...
				if ((InventoryGet(target[0], "ItemVulvaPiercings") != null) && (InventoryGet(target[0],
						"ItemVulvaPiercings").Asset.AllowLock == true)) {
					if (((InventoryGet(target[0], "ItemVulvaPiercings").Property != null) && (InventoryGet(target[
							0], "ItemVulvaPiercings").Property.LockedBy == null)) || (InventoryGet(target[0],
							"ItemVulvaPiercings").Property == null)) {
						InventoryLock(target[0], "ItemVulvaPiercings", Lock, mn);
						if (removeitem == "r") {
							InventoryGet(target[0], "ItemVulvaPiercings").Property.RemoveItem = true;
						}
						if (minutes != null) {
							InventoryGet(target[0], "ItemVulvaPiercings").Property.RemoveTimer = InventoryGet(
								target[0], "ItemVulvaPiercings").Property.RemoveTimer + (time * 60 * 1000);
						}
						if (hidetimer == "h") {
			...
			ChatRoomSendLocal(
				"Quick-AccessMenu2: A few things have to be set manually. See the /roleplay and /rolequit commands."
			);
			...
			if (target[0] != null) {
				ServerSend("ChatRoomChat", {
					...
					Dictionary: [{
						Tag: "Beep",
						Text: "Magical lasers make disappear the clothes on " + target[0].Nickname +
							" body."
					}]
				});
				if ((target[0].Name == Player.Name) == false) {
			...
			if (content.includes("load1")) {
				ChatRoomSendLocal(
					"Quick-AccessMenu2: You have 5 seconds to click on target. If successful, the outfit will be loaded. If not, retry."
				);
				setTimeout(function() {
				...
				ChatRoomSendLocal(
					"Quick-AccessMenu2: You have 5 seconds to click on target. If successful, the outfit will be saved. If not, retry."
				);
				setTimeout(function() {
				...
				if (appinp) {
					...
					setTimeout(function() {
						...
						appobj.forEach(itemstr => {
							InventoryWear(CurrentCharacter, itemstr[0], itemstr[1], itemstr[2],
								itemstr[3], -1, itemstr[4]);
						});
						ChatRoomCharacterUpdate(CurrentCharacter);
						DialogLeave();
					}, 5000);
			...
			if (target[0] != null) {
				...
				CharacterNaked(target[0]);
				InventoryWearRandom(target[0], "ItemArms", 8, null, false, true, ["ArmbinderJacket", "BitchSuit",
					"BitchSuitExposed", "Bolero", "BoxTieArmbinder", "Chains", "FullLatexSuit", "HempRope",
					"InflatableStraightLeotard", "LatexBoxtieLeotard", "LatexButterflyLeotard",
					"LatexSleevelessLeotard", "LeatherStraitJacket", "StraitLeotard",
					"StrictLeatherPetCrawler"
				], true);
				InventoryWearRandom(target[0], "HairAccessory1", 8, null, false, true, ["Antennae", "BunnyEars1",
					"BunnyEars2", "CowHorns", "Ears1", "Ears2", "ElfEars", "FoxEars1", "FoxEars2",
					"FoxEars3", "KittenEars1", "KittenEars2", "MouseEars1", "MouseEars2", "PonyEars1",
					"PuppyEars1", "PuppyEars2", "RaccoonEars1", "WolfEars1", "WolfEars2"
				], true);
				InventoryWearRandom(target[0], "TailStraps", 8, null, false, true, ["CowtailStrap", "FoxTailsStrap",
					"FoxTailStrap1", "FoxTailStrap2", "HorseTailStrap", "HorseTailStrap1",
					"KittenTailStrap1", "KittenTailStrap2", "MouseTailStrap1", "MouseTailStrap2",
					"PuppyTailStrap", "PuppyTailStrap1", "RaccoonStrap", "WolfTailStrap1", "WolfTailStrap2",
					"WolfTailStrap3"
				], true);
				...
				if (InventoryGet(target[0], "ItemNeckRestraints") == null) InventoryWear(target[0], "ChainLeash",
					"ItemNeckRestraints", null, 8);
					...
					if (content.includes("armsfree")) {
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " lets " + target[0].Nickname +
										" relax her arms."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to stay on her belly."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to put the arms behind her back."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname +
										" puts her arms out like she's handcuffed."
								}]
							});
						} else {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to put the arms out like she's handcuffed."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname +
										" puts the arms behind her back, elbows almost touching."
								}]
							});
						} else {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to put the arms behind her back, elbows almost touching."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " helps " + target[0].Nickname +
										" to kneel down."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " helps " + target[0].Nickname +
										" to kneel down, forcing her legs open."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " helps " + target[0].Nickname +
										" to stand up with her legs closed."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " helps " + target[0].Nickname +
										" to stand up normally on her feet."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							...
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to raise the hands above her head."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname +
										" raises her hands and spreads her legs."
								}]
							});
						} else {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to raise their hands and spread her legs."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname +
										" raises the hands above her head and spreads her legs."
								}]
							});
						} else {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to raise the hands above their head and spread her legs."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname +
										" is now in an acrobatic pose in suspension."
								}]
							});
						} else {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" in an acrobatic pose in suspension."
								}]
							});
						}
						...
						if (target[0].Name == Player.Name) {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname +
										" puts her arms out like her hands are taped."
								}]
							});
						} else {
							ServerSend("ChatRoomChat", {
								...
								Dictionary: [{
									Tag: "Beep",
									Text: "" + Player.Nickname + " forces " + target[0].Nickname +
										" to put the arms out like her hands are taped."
								}]
							});
						}
					}
			...
			ServerSend("ChatRoomChat", {
				...
				Dictionary: [{
					Tag: "Beep",
					Text: "" + Player.Nickname +
						" gets grabbed by two maids and sent to Pandora prison for " + minutes +
						" minutes."
				}]
			});
			DialogLentLockpicks = false;
			...
			if (target[0] != null) {
				ServerSend("ChatRoomChat", {
					...
					Dictionary: [{
						Tag: "Beep",
						Text: "Magical lasers apply random clothes and bindings on " + target[0]
							.Nickname + " body."
					}]
				});
				if ((target[0].Name == Player.Name) == false) {
			...
			if (target[0] != null) {
				ServerSend("ChatRoomChat", {
					...
					Dictionary: [{
						Tag: "Beep",
						Text: "Magical lasers make disappear the bindings on " + target[0]
							.Nickname + " body."
					}]
				});
				if ((target[0].Name == Player.Name) == false) {
			...
			if (content.includes("yes")) {
				...
				ChatRoomSendLocal(
					"<b>Warning</b>: Resetting difficulty will incur a 7-day waiting period to rechange. Confirm by typing: <b>/resetdifficulty yes</b>"
				);
			}
			...
			if (content.includes("yes")) {
				...
				ChatRoomSendLocal(
					"<b>Warning</b>: You will lose many clothes and items, you will need to buy them again. Confirm by typing: <b>/resetinventory yes</b>"
				);
			}
			...
			if (target[0] != null) {
				ServerSend("ChatRoomChat", {
					...
					Dictionary: [{
						Tag: "Beep",
						Text: "Magical lasers apply random restraints on " + target[0].Nickname +
							" body."
					}]
				});
				if ((target[0].Name == Player.Name) == false) {
			...
			setTimeout(function() {
				if (CurrentCharacter !== Player) {
					ServerSend("ChatRoomChat", {
						Content: "Quick-Access Menu2: " + Player.Name + " has removed " +
							InventoryGet(CurrentCharacter, CurrentCharacter.FocusGroup.Name).Asset
							.Name + " on you via console. If this is undesired, blacklist player.",
						Type: "Whisper",
						Target: CurrentCharacter.MemberNumber
					})
				};
				CurrentCharacter.Appearance = CurrentCharacter.Appearance.filter(x => (CurrentCharacter
						.FocusGroup && CurrentCharacter.FocusGroup.Name) ? x.Asset.Group.Name !=
			...
			if (content.includes("club") || content.includes("Club") || content.includes("LARP") || content
				.includes("larp")) {
				setTimeout(function() {
					ChatRoomSpace = "";
					CommonSetScreen("Online", "ChatSearch");
				...
				if (target[0].Name == Player.Name) {
					ServerSend("ChatRoomChat", {
						...
						Dictionary: [{
							Tag: "Beep",
							Text: "" + Player.Nickname +
								" swallows a sleeping pill and drinks a glass of water. She falls asleep very quickly."
						}]
					});
				} else {
					ServerSend("ChatRoomChat", {
						...
						Dictionary: [{
							Tag: "Beep",
							Text: "" + Player.Nickname + "feeds " + target[0].Nickname +
								" a sleeping pill and gives her a glass of water. " + target[0]
								.Nickname + " falls asleep very quickly."
						}]
					});
				}
			}
				...
				if (InventoryGet(Player, "ItemDevices").Asset.Name == "FuturisticCrate") {
					if (solidity < 2) {
						...
						ServerSend("ChatRoomChat", {
							...
							Dictionary: [{
								Tag: "Beep",
								Text: "Magical lasers make disappear the futuristic crate in which " +
									Player.Nickname + " was prisoner."
							}]
						});
					}
				}
		...
		} else if ((content.indexOf("/speak") == 0) || (content.indexOf("/mouth") == 0) || (content.indexOf(
				"/speech") == 0)) {
			...
			ServerSend("ChatRoomChat", {
				...
				Dictionary: [{
					Tag: "Beep",
					Text: "" + Player.Nickname + " rolls a superdice of " + sides +
						" sides. The result is " + Result + "."
				}]
			});
			...
			ServerSend("ChatRoomChat", {
				...
				Dictionary: [{
					Tag: "Beep",
					Text: "" + Player.Nickname +
						" gets grabbed by two maids and locked in a timer cell for " + minutes +
						" minutes."
				}]
			});
			DialogLentLockpicks = false;
			...
			if (content.endsWith("/title")) {
				...
				if (title == "agent") {
					if ((SkillGetLevel(Player, "Infiltration") < 6) || (SkillGetLevel(Player, "Infiltration") >
							7)) {
					...
					if ((LogQuery("JoinedSorority", "Maid") == false) || (LogQuery("LeadSorority", "Maid") ==
							false)) {
						LogAdd("JoinedSorority", "Management");
					}
					if (SkillGetLevel(Player, "Evasion") < 10) {
					...
					if (ReputationGet("ABDL") < 1) {
						if ((SkillGetLevel(Player, "Dressage") < 1) || (SkillGetLevel(Player, "Infiltration") >
								2)) {
					...
					if ((SkillGetLevel(Player, "Infiltration") < 4) || (SkillGetLevel(Player, "Infiltration") >
							5)) {
					...
					if ((SkillGetLevel(Player, "Infiltration") < 2) || (SkillGetLevel(Player, "Infiltration") >
							3)) {
					...
					if ((SkillGetLevel(Player, "Infiltration") < 8) || (SkillGetLevel(Player, "Infiltration") >
							9)) {
			...
			if (target[0] != null) {
				ServerSend("ChatRoomChat", {
					...
					Dictionary: [{
						Tag: "Beep",
						Text: "Magical lasers make disappear all bindings and toys on " + target[0]
							.Nickname + " body."
					}]
				});
				if ((target[0].Name == Player.Name) == false) {
			...
			if (target[0] != null) {
				ServerSend("ChatRoomChat", {
					...
					Dictionary: [{
						Tag: "Beep",
						Text: "Magical lasers make disappear locks on " + target[0].Nickname +
							" body."
					}]
				});
				if ((target[0].Name == Player.Name) == false) {
			...
			if (content.includes("soft")) {
				...
				StruggleProgressStart = function(C, PrevItem, NextItem) {
					if (InventoryGet(CurrentCharacter, CurrentCharacter.FocusGroup.Name) == null) {
						if (C != Player || PrevItem == null || ((PrevItem != null) && (!InventoryItemHasEffect(
								PrevItem, "Lock", true) || DialogCanUnlock(C, PrevItem)) && ((Player
									.CanInteract() && !InventoryItemHasEffect(PrevItem, "Mounted", true)) ||
			...
			if (content.endsWith("/unrestrict")) {
				...
				ChatSearchMuffle = function(Text) {
					let ret = Text;
					if (Player.ImmersionSettings && Player.ImmersionSettings.ChatRoomMuffle && Player
						.GetBlindLevel() > 0) {
						ret = SpeechGarbleByGagLevel(Player.GetBlindLevel() * Player.GetBlindLevel(), Text,
							true);
				...
				Player.CanWalk = function() {
					return (
						...
						((this.Pose == null) || (this.Pose.indexOf("Kneel") < 0) || (this.Effect.indexOf(
							"KneelFreeze") < 0)))
				}
				Player.IsPlugged = function() {
				...
				Player.GetBlindLevel = function(eyesOnly = false) {
					...
					if (eyes1 && eyes1.Property && eyes1.Property.Expression && eyes2 && eyes2.Property && eyes2
						.Property.Expression) {
						if ((eyes1.Property.Expression === "Closed") && (eyes2.Property.Expression ===
								"Closed")) {
					...
					if (this.IsPlayer() && this.GameplaySettings && this.GameplaySettings.SensDepChatLog ==
						"SensDepLight") blindLevel = Math.min(2, blindLevel);
					return blindLevel;
				}
				...
				DialogHasKey = function(C, Item) {
					if (InventoryGetItemProperty(Item, "SelfUnlock") == false && (!Player.CanInteract() || C
							.ID == 0)) return false;
					if (C.IsOwnedByPlayer() && InventoryAvailable(Player, "OwnerPadlockKey", "ItemMisc") && Item
						.Asset.Enable) return true;
					const lock = InventoryGetLock(Item);
					if (C.IsLoverOfPlayer() && InventoryAvailable(Player, "LoversPadlockKey", "ItemMisc") &&
						Item.Asset.Enable && Item.Property && Item.Property.LockedBy && !Item.Property.LockedBy
						.startsWith("Owner")) return true;
					if (lock && lock.Asset.ExclusiveUnlock && ((!Item.Property.MemberNumberListKeys && Item
							.Property.LockMemberNumber != Player.MemberNumber) || (Item.Property
							.MemberNumberListKeys && CommonConvertStringToArray("" + Item.Property
								.MemberNumberListKeys).indexOf(Player.MemberNumber) < 0))) return false;
					if (lock && lock.Asset.ExclusiveUnlock) return true;
					var UnlockName = "Unlock-" + Item.Asset.Name;
					if ((Item.Property != null) && (Item.Property.LockedBy != null)) UnlockName = "Unlock-" +
				...
				StruggleStrengthStart = function(C, PrevItem, NextItem) {
					...
					if ((PrevItem && PrevItem.Asset) || (NextItem && NextItem.Asset)) {
						var AudioFile = (NextItem && NextItem.Asset) ? NextItem.Asset.Audio : PrevItem.Asset
							.Audio;
						if (AudioFile != null) AudioDialogStart("Audio/" + AudioGetFileName(AudioFile) +
							".mp3");
					}
					if (Player.CanInteract()) {
						...
						if ((StruggleProgressAuto < 0) && Player.CanInteract() && (PrevItem == null))
							StruggleProgressAuto = 0;
						if ((StruggleProgressAuto < 0) && Player.CanInteract() && (PrevItem != null) && (!
								InventoryItemHasEffect(PrevItem, "Lock", true) || DialogCanUnlock(C, PrevItem)
							) && !InventoryItemHasEffect(PrevItem, "Mounted", true)) StruggleProgressAuto =
							0;
						DialogAllowBlush = ((StruggleProgressAuto < 0) && (StruggleProgressChallenge > 0) && (C
							.ID == 0) && ((InventoryGet(C, "Blush") == null) || (InventoryGet(C,
							"Blush").Property == null) || (InventoryGet(C, "Blush").Property
							.Expression == null)));
						DialogAllowEyebrows = ((StruggleProgressAuto < 0) && (StruggleProgressChallenge > 0) &&
							(C.ID == 0) && ((InventoryGet(C, "Eyebrows") == null) || (InventoryGet(C,
								"Eyebrows").Property == null) || (InventoryGet(C, "Eyebrows").Property
								.Expression == null)));
						DialogAllowFluids = ((StruggleProgressAuto < 0) && (StruggleProgressChallenge > 0) && (C
							.ID == 0) && ((InventoryGet(C, "Fluids") == null) || (InventoryGet(C,
							"Fluids").Property == null) || (InventoryGet(C, "Fluids").Property
							.Expression == null)));
					}
				}
				StruggleProgressStart = function(C, PrevItem, NextItem) {
					if (InventoryGet(CurrentCharacter, CurrentCharacter.FocusGroup.Name) == null) {
						...
						ServerSend("ChatRoomChat", {
							...
							Dictionary: [{
								Tag: "Beep",
								Text: Player.Name + " removes the " + InventoryGet(
										CurrentCharacter, CurrentCharacter.FocusGroup.Name)
									.Asset.Name + " from " + CurrentCharacter.Name + "'s " +
						...
						StruggleStrengthStart(Player, StruggleProgressChoosePrevItem,
							StruggleProgressChooseNextItem);
					}
				}
					...
					if (Item != null && lock) {
						...
						if (!Player.CanInteract() && (Item != null)) {
							if (InventoryItemHasEffect(Item, "NotSelfPickable", true)) {
								...
								if (!C.CanTalk()) S = S - 1;
								if (InventoryItemHasEffect(InventoryGet(Player, "ItemLegs"), "Block", true)) S = S -
									1;
								if (InventoryItemHasEffect(InventoryGet(Player, "ItemFeet"), "Block", true)) S = S -
									1;
						...
						StruggleLockPickProgressSkill = Math.floor(NumPins * NumPins / 2) + Math.floor(Math.max(0, -
							S) * Math.max(0, -S));
						...
						if (Item.Property != null)
							if ((Item.Property.LockPickSeed == null) || (typeof Item.Property.LockPickSeed !=
									"string")) {
						...
						if (S < -6 && LockPickingImpossible) {
							...
							StruggleLockPickImpossiblePins.push(StruggleLockPickOrder[StruggleLockPickOrder.length -
								1]);
							if (NumPins >= 6) StruggleLockPickImpossiblePins.push(StruggleLockPickOrder[
								StruggleLockPickOrder.length - 2]);
							if (NumPins >= 8) StruggleLockPickImpossiblePins.push(StruggleLockPickOrder[
								StruggleLockPickOrder.length - 3]);
						}
						var NumTries = Math.max(Math.floor(NumPins * (1.5 - 0.3 * BondageLevel / 10)),
							Math.ceil(NumPins * (3.25 - BondageLevel / 10) - Math.max(0, (
								StruggleLockPickProgressChallenge + BondageLevel / 2) * 1.5)));
...
ChatCommandGreeting = function(data) {
	if (CurrentScreen == "ChatRoom" && data.Content == "ServerEnter") {
		Player.RestrictionSettings.BypassNPCPunishments = true;
		ChatRoomSendLocal(
			"Quick-AccessMenu2-1.5.0版：准备好了，请输入 <b>/help</b> 以查看常规菜单。\n" +
...
function LoginDoLogin() { //rewrite login to variabilize credentials for later use
	if (!LoginSubmitted && ServerIsConnected) {
		...
		if (LoginName.match(letters) && LoginPassword.match(letters) && (LoginName.length > 0) && (LoginName.length <=
				20) && (LoginPassword.length > 0) && (LoginPassword.length <= 20)) {
			LoginSetSubmitted();
			ServerSend("AccountLogin", {
...
function consoleWhisper() {
	ServerSend("ChatRoomChat", {
		Content: "Quick-Access Menu2: " + Player.Name +
			" has used console to alter appearance. If this is undesired, blacklist player.",
		Type: "Whisper",
...
function RunExpressionAnimation(list) {
	...
	if (expressionAnimationEx && expressionAnimationEx.Property && expressionAnimationEx.Property.Expression) {
		expressionAnimation[expressionAnimation.length - 1] = expressionAnimationEx.Property
			.Expression; //set last to current
	}
...
var M_MOANER_vibratorStatus = ["The vibes moan is active. If your vibrator's setting changes, you will moan.",
	"The vibes moan is not active. If your vibrator's setting changes, you will not moan."
];
...
async function MoanerLoginListener() {
	while (!MoanerIsLoaded) {
		try {
			while ((!window.CurrentScreen || window.CurrentScreen == "Login" || (typeof window.CursedStarter ===
					"function" && window.cursedConfig === undefined)) && !MoanerIsLoaded) {
...
M_MOANER_defaultMoans = {
	...
	"low": ["mh", "\u2665oh\u2665", "ah", "...\u2665"],
	"orgasm": ["Nya...Ny...NyaaAAaah!", "Mmmmh... MMmh... Hhhmmmm...", "Oooooh... Mmmmh... OooOOOOh!",
		"Mmmhnn... Nyhmm... Nyah!"
	],
...
function M_MOANER_reactionOrgasm(C) {
	if (M_MOANER_orgasmActive && M_MOANER_scriptOn && C.MemberNumber == Player.MemberNumber && window.CurrentScreen ==
		"ChatRoom") {
...
function M_MOANER_isPlayerTarget(data) {
	...
	for (index in array) {
		let elem = array[index];
		if ((elem.Tag == "DestinationCharacter" || elem.Tag == "TargetCharacter" || elem.Tag ==
				"DestinationCharacterName") && elem.MemberNumber == Player.MemberNumber) {
			return true;
		}
	}
	return false;
...
function IsStimulated(C) {
	if (C.IsEgged() && ((C.ArousalSettings == null) || (C.ArousalSettings.AffectStutter == null) || (C.ArousalSettings
			.AffectStutter == "Vibration") || (C.ArousalSettings.AffectStutter == "All")))
...
vnekoMoans = {
	"hot": ["嗯... 咕呜♥", "啊呜❤~", "——❤~", "咿呀❤~~~", "哈❤~~~"],
	"medium": ["姆", "啊❤", "噫呜❤"],
	"light": ["唔姆❤", "啊啊❤", "嗯", "呜~", "唔啊❤", "哈啊❤~"],
	"low": ["啊", "❤唔啊❤", "嗯嗯", "...♥", "哼嗯♥~"],
	"orgasm": ["咕...呜❤~", "嗯啊...嗯嗯❤... 咕嗯❤...", "啊... 嗯... 嗯嗯❤ ... 呼~!", "嗯喵... 嗯嗯... 呜❤~!"],
	"pain": ["咿呀❤~", "呜噫❤~", "咕呜❤~!", "不...不可以❤...", "坏蛋❤~", "大坏蛋❤~", "没吃饭嘛❤~", "呀❤~", "好疼呜...", "别再打了...", "咬你哦~",
		"真的咬你哦！"
	]
}
...
// 小灵专用
skyusoulMoans = {
	"hot": ["嗯... 咕呜♥", "啊呜~", "嗯~呼~!", "咿呀❤~~~", "哈❤~~~"],
	"medium": ["姆", "啊❤", "噫呜❤"],
	"light": ["唔姆❤", "啊啊❤", "嗯", "呜~", "唔啊❤", "哈啊❤~"],
	"low": ["啊", "❤唔啊❤", "嗯嗯", "...♥", "哼嗯♥~"],
	"orgasm": ["咿-咿呀！小灵，小灵高潮了~❤", "哈-哈啊……这样子在别人面前吐着舌头，小灵真是太变态了，嘻嘻~❤", "唔唔~❤哈啊，淫水，淫水喷出来了……啊啊，只是闻到就要发情了~❤",
		"嘿嘿~❤大家喜欢看小灵高潮的样子吗？喜欢的话，小灵就在表演一次哦~❤讨厌的话，就惩罚小灵吧~❤", "哦哦~❤高潮的样子被大家看到什么的~小灵已经只能当一个一直发情的高潮人偶了~",
		"哈啊~❤高潮……好棒~❤小灵，最喜欢在大家面前进行高潮表演了~❤"
	],
	"pain": ["咿呀❤~", "呜噫❤~", "咕呜❤~!", "哈-哈啊~屁股被打了，好痛~❤", "对不起！请惩罚小灵淫乱的屁股吧~❤", "哈啊~❤主人，只是拍打，小灵会发情的疯掉的~❤",
		"嘿-嘿嘿~这样子拍打小灵的屁股的话，小灵会兴奋的停不下来的~❤", "咿-咿呀~❤", "哈啊……哈啊~❤", "汪呜~❤"
	]
}

M_MOANER_addMoansProfile("skyusoul", skyusoulMoans);
...
M_MOANER_wildFoxMoans = {
	...
	"orgasm": ["WAAAAOUUUUUUUHHHHH!", "Mmmhnn... Wiiif... Yiiiif!!", "AOUUUUUH!", "WAHOOOOOOOUUUUH!",
		"WAAAAAAAAHH!", "WAAAAOUUUUUUUHHHHH!", "AOUUUUUH!", "WAHOOOOOOOUUUUH!", "WAAAAAAAAHH!"
	],
	"pain": []
}
...
function bcdwCommands(chatCommand, callerID, type) {
	...
	if (callerID === Player.MemberNumber) {
		...
		if (chatCommand[chatCommand.length - 1] === "start") {
			...
			let commandArguments = ["wetchance", "messchance", "desperation", "regression", "timer", "wetpanties",
				"messpanties", "wetchastity", "messchastity"
			];
			...
			while (commandArguments.includes(chatCommand[chatCommand.length - 1])) {
				...
				switch (tempVal) {
					case commandArguments[0]:
						caughtArguments.initWetChance = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.wetChance : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[1]:
						caughtArguments.initMessChance = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.messChance : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[2]:
						caughtArguments.initDesperationLevel = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.desperationLevel : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[3]:
						caughtArguments.initRegressionLevel = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.regressionLevel : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[4]:
						caughtArguments.baseTimer = (isNaN(chatCommand[chatCommand.length - 1])) ? diaperDefaultValues
							.baseTimer : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[5]:
						caughtArguments.initWetLevelInner = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.wetLevelInner : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[6]:
						caughtArguments.initMessLevelInner = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.messLevelInner : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[7]:
						caughtArguments.initWetLevelOuter = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.wetLevelOuter : chatCommand[chatCommand.length - 1];
						break;
					case commandArguments[8]:
						caughtArguments.initMessLevelOuter = (isNaN(chatCommand[chatCommand.length - 1])) ?
							diaperDefaultValues.messLevelOuter : chatCommand[chatCommand.length - 1];
						break;
				}
				chatCommand.pop();
			}
	...
	// Chat commands that can be executed by other people
	{
		...
		if (chatCommand[chatCommand.length - 2] === Player.MemberNumber || type === "Whisper" || callerID === Player
			.MemberNumber) {
					...
					if (!(checkForDiaper("panties") || checkForDiaper("chastity"))) {
						ServerSend("ChatRoomChat", {
							...
							Dictionary: [{
								Tag: "gag",
								Text: Player.Nickname +
									" doesn't have a diaper! Get one on her before she makes a mess!"
							}]
						});
					} else {
						refreshDiaper({
...
function diaperWetter({
	...
	desperationLevel =
		initDesperationLevel; // Used for tracking how recently a milk bottle has been used (affects the timer)
...
function refreshDiaper({
	...
	if (cdiaper === "both") {
		...
		} else if ((checkForDiaper("Panties") && !checkForDiaper("ItemPelvis")) || (checkForDiaper("ItemPelvis") && !
				checkForDiaper("Panties"))) {
			ServerSend("ChatRoomChat", {
				Type: "Action",
				Content: "gag",
				Dictionary: [{
...
function checkForDiaper(slot) {
	return InventoryGet(Player, slot)?.Asset?.Name === "PoofyDiaper" || InventoryGet(Player, slot)?.Asset?.Name ===
		"BulkyDiaper";
}

// Checks to see if the user has a nursery milk equiped
function checkForNurseryMilk() {
	return (InventoryGet(Player, "ItemMouth")?.Asset?.Name === "RegressedMilk") || (InventoryGet(Player, "ItemMouth2")
		?.Asset?.Name === "RegressedMilk") || (InventoryGet(Player, "ItemMouth3")?.Asset?.Name === "RegressedMilk");
}

// Checks for a normal milk bottle
function checkForMilk() {
	return (InventoryGet(Player, "ItemMouth")?.Asset?.Name === "MilkBottle") || (InventoryGet(Player, "ItemMouth2")
		?.Asset?.Name === "MilkBottle") || (InventoryGet(Player, "ItemMouth3")?.Asset?.Name === "MilkBottle");
}
...
function diaperTick() {
	...
	if (testMess > 1 - messChance) {
		...
		if ((MessLevelPanties === 2 && checkForDiaper("Panties") && !checkForDiaper("ItemPelvis")) || (
				MessLevelChastity === 2 && checkForDiaper("ItemPelvis") && !checkForDiaper("Panties"))) {
			ServerSend("ChatRoomChat", {
				Type: "Action",
				Content: "gag",
				Dictionary: [{
	...
	// If the baby only wets, increment the wet level to a max of 2.
		...
		if (WetLevelPanties == 2 && (InventoryGet(Player, "Panties") !== "PoofyDiaper" && InventoryGet(Player,
				"Panties") !== "BulkyDiaper")) {
		...
		if ((WetLevelPanties === 2 && checkForDiaper("Panties") && !checkForDiaper("ItemPelvis")) || (
				WetLevelChastity === 2 && checkForDiaper("ItemPelvis") && !checkForDiaper("Panties"))) {
			ServerSend("ChatRoomChat", {
				Type: "Action",
				Content: "gag",
				Dictionary: [{
...
function ChatRoomSyncItem(data) {
	if ((data == null) || (typeof data !== "object") || (data.Source == null) || (typeof data.Source !== "number") || (
			data.Item == null) || (typeof data.Item !== "object") || (data.Item.Target == null) || (typeof data.Item
			.Target !== "number") || (data.Item.Group == null) || (typeof data.Item.Group !== "string")) return;
	for (let C = 0; C < ChatRoomCharacter.length; C++)
		if (ChatRoomCharacter[C].MemberNumber === data.Item.Target) {
			...
			if (item) {
				...
				const cyclicBlockSanitizationResult = ValidationResolveCyclicBlocks(ChatRoomCharacter[C].Appearance,
					diffMap);
...
function CharacterRefresh(C, Push, RefreshDialog = true) {
	...
	C.RunScripts = (!C.AccountName.startsWith('Online-') || !(Player.OnlineSettings && Player.OnlineSettings
...
function PandoraPrisonRun() {
	...
	if ((Player.Infiltration.Punishment.Timer >= CurrentTime) && (PandoraPrisonCharacterTimer < CommonTime()) && (
			CurrentCharacter == null) && !PandoraPrisonEscaped) {
	...
	if (Player.Infiltration.Punishment.Timer > CurrentTime) {
		DrawText(TextGet("Sentence") + " " + Player.Infiltration.Punishment.Minutes.toString() + " " + TextGet(
			"Minutes"), 1800, 870, "White", "Black");
		DrawText(TextGet("EndsIn") + " " + TimerToString(Player.Infiltration.Punishment.Timer - CurrentTime), 1800, 920,
			"White", "Black");
	}
...
function CellClick() {
	if (MouseIn(1885, 25, 90, 90) && Player.CanKneel() && (CellOpenTimer > CurrentTime)) CharacterSetActivePose(Player,
		(Player.ActivePose == null) ? "Kneel" : null, true);
...
function StablePonyEnd() {
	...
	for (let E = Player.Appearance.length - 1; E >= 0; E--)
		if ((Player.Appearance[E].Asset.Group.Name == "ItemTorso") || (Player.Appearance[E].Asset.Group.Name ==
				"Hat") || (Player.Appearance[E].Asset.Group.Name == "ItemButt")) {
...
setTimeout(function() {
	ServerSocket.on("ChatRoomMessage", function(data) {
		...
		if (tenorRe.test(data.Content)) {
			...
			if (content) {
				...
				if (data.Content.startsWith('whisper')) {
					senderName.innerHTML =
						`<span class="ChatMessage ChatMessageWhisper" style="text-shadow: none; padding-left: 0px;">(Whisper)</span> ` +
				...
				if (tenorRe.test(data.Content) && (chatWindow.scrollHeight - chatWindow.offsetHeight -
			...
			if (content && content[5] && content[5].length == 11 && (content.includes("youtube.com") ||
...
function ChatSearchJoin() { //rewrite chatroom join to house auto join
	var X = 25;
	var Y = 25;
	for (let C = ChatSearchResultOffset; C < ChatSearchResult.length && C < (ChatSearchResultOffset +
			ChatSearchRoomsPerPage); C++) {
		if (ChatSearchLastQueryJoin != RoomName || (ChatSearchLastQueryJoin == RoomName && ChatSearchLastQueryJoinTime +
				1000 < CommonTime())) {
