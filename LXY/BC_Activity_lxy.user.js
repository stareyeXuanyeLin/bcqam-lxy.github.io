(function () {
    ...
    mod.hookFunction("ChatRoomMessage", 0, (args, next) => {
        ...
        if (luzi2 === null) {
            currentLanguage2 = ''; // 当 luzi2 为 null 时将 currentLanguage2 设置为空字符串
        } else if (luzi2.Asset.Name === "TeddyBear" && luzi2.Craft && luzi2.Craft.Description) {
            currentLanguage2 = luzi2.Craft.Description.replace(/"/g, ''); // 当 luzi2 不为 null 且满足条件时执行操作
        } else { }
...
// InventoryIsItemInList(Player, "ItemArms", "PawMittens")
// InventoryRemove(Player, "ItemArms");

// Player.IsKneeling() // 跪下
// Player.IsProne() // 趴下
// ChatRoomCanStopHoldLeash()
